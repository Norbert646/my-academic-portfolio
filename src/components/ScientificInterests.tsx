          ...
          {scientificInterests.map((card, i) => {
            ...
            return (
              <motion.button
                ...
                className="group relative text-left rounded-2xl border border-navy/10 bg-white p-7 overflow-hidden hover:shadow-[0_16px_40px_rgba(11,29,48,0.08)] hover:border-teal/30 transition-all duration-300"
              >
                <div className="absolute top-0 right-0 w-24 h-24 bg-teal/5 rounded-full -translate-y-8 translate-x-8 group-hover:scale-150 transition-transform duration-500" />
